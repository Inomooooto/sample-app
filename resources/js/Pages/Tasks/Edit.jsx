        ...
        <AuthenticatedLayout
            header={
                <div className="flex justify-between items-center">
                    <h2 className="text-2xl font-bold text-amber-400" style={{ fontFamily: 'Georgia, serif', textShadow: '0 0 20px rgba(251, 191, 36, 0.5)' }}>クエスト編集</h2>
                    <Link
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-6">
                                    ...
                                    <input
                                        ...
                                        className="input input-bordered w-full bg-indigo-950/50 border border-indigo-700/50 focus:border-indigo-500 focus:ring focus:ring-amber-300"
                                ...
                                <div className="mb-6">
                                    ...
                                    <textarea
                                        ...
                                        className="textarea textarea-bordered w-full h-32 bg-indigo-950/50 border border-indigo-700/50 focus:border-indigo-500 focus:ring focus:ring-amber-300"
                                        style={{ fontFamily: 'Georgia, serif' }}
                                        ...
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={`btn btn-sm ${data.difficulty === difficulty.value
                                                    ? `${difficulty.color} text-white border border-indigo-700/50`
                                ...
                                {/* ステータス選択 */}
                                <div className="mb-6">
                                    <label htmlFor="status" className="block text-indigo-100 font-bold mb-2" style={{ fontFamily: 'Georgia, serif' }}>
                                        状態
                                    </label>
                                    <select
                                        id="status"
                                        ...
                                        className="select select-bordered w-full bg-indigo-950/50 border border-indigo-700/50 focus:border-indigo-500 focus:ring focus:ring-amber-300"
                                        style={{ fontFamily: 'Georgia, serif' }}
                                    >
                                ...
                                <div className="flex justify-end gap-4 mt-8">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className="btn bg-blue-700 hover:bg-blue-800 text-white border-none"
                                    >
                                        変更を保存
                                    </button>
                                </div>
